...
var StepperForm = function (_a) {
    var steps = _a.steps, onSubmit = _a.onSubmit, stepperProps = _a.stepperProps, icons = _a.icons, header = _a.header, formMethods = _a.formMethods, formOptions = _a.formOptions;
    ...
    return (react_1.default.createElement(react_hook_form_1.FormProvider, __assign({}, methods),
        react_1.default.createElement("form", { onSubmit: handleSubmit(onSubmit), className: "w-full" }, header === null || header === void 0 ? void 0 :
            header({
                nextStep: handleNext,
                prevStep: prevStep,
            ...
            react_1.default.createElement(core_1.Stepper, __assign({ className: "p-10 rounded-xl bg-basic-white shadow-form-sheet", active: activeStep, completedIcon: icons === null || icons === void 0 ? void 0 : icons.completed }, stepperProps), steps.map(function (step, index) { return (react_1.default.createElement(core_1.Stepper.Step, { key: index, label: step.label, description: step.description, icon: activeStep === index ? icons === null || icons === void 0 ? void 0 : icons.active : undefined },
                react_1.default.createElement("div", { className: "mt-6" }, step.component))); })))));
};
